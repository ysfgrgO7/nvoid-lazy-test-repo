...
local config = nvoid.theme
local base46_path = vim.fn.fnamemodify(debug.getinfo(1, "S").source:sub(2), ":p:h")

M.get_theme_tb = function(type)
  local default_path = "base46.themes." .. g.nvoidtheme
  local user_path = "custom.themes." .. g.nvoidtheme
...
M.compile = function()
  ...
  local extended_integrations = config.extended_integrations
...
M.toggle_theme = function()
  ...
  if g.nvoidtheme ~= theme1 and g.nvoidtheme ~= theme2 then
